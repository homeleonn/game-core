...
class UserRepository
{
	...
	{
		return DB::getRow('SELECT id, login, level, power, critical, evasion, stamina, last_restore, sex, clan, gold, exp, win, defeat, draw, request, fight, image, title, color, curhp, maxhp, team, loc, trans_time, trans_timeout FROM users WHERE id = ?i', $userId);
